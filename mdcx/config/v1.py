...
class ConfigV1:
    ...
    poster_website_exclude: str = r"fc2club,fc2hub,iqqtv,7mmtv,javlibrary,lulubar"
    ...
    runtime_website_exclude: str = r"airav_cc,fc2,fc2club,fc2hub,lulubar"
    ...
    llm_key: str = r""
    llm_prompt_title: str = "Please translate the following text to {lang}. Output only the translation without any explanation.\n{content}"  # 原文-{content} 目标语言-{lang}
    llm_prompt_outline: str = "Please translate the following text to {lang}. Output only the translation without any explanation.\n{content}"  # 原文-{content} 目标语言-{lang}
